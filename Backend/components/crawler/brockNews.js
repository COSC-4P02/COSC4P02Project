      ...
      if (rss.title != "failed") {
        ...
        axios
          ...
          .then((data) => {
            ...
            for (const item of data) {
              ...
              try {
                rss.items[count]["image"] =
                  dom.window.document.querySelector(".main-image").href;
              } catch (e) {
                rss.items[count]["image"] =
                  "https://brocku.ca/brock-news/wp-content/uploads/2018/11/Brock-University-Campus-LR-1600x899.jpg?";
              }
              count++;
            }
            ...
            print(
              "Crawler: Brock News RSS Read Successfully | Saved to database"
            );
            if (!sent) result(rss);
          });
      } else {
